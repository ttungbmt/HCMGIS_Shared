  ...
  <div class="flex flex-row justify-between items-center w-full" v-if="hasValue">
    ...
    <div class="flex flex-row">
      <button ref="copyButton" v-if="copyToClipboard" type="button" v-tooltip.click="__('Copy')"
              class="text-70 hover:text-primary mr-2">
      ...
      <button v-tooltip.click="__('Show')" type="button" class="text-70 hover:text-primary" @mousedown="handleMouseDown"
...
export default {
  ...
  computed: {
    ...
    copyToClipboard: function () {
      return !!this.field.copyToClipboard;
    },
  },
  mounted() {
