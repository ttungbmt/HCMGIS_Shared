    ...
    <template slot="value">
      <div class="w-full flex justify-between items-center flex-row" v-if="hasValue">
        ...
        <div class="flex flex-row">
          <button ref="copyButton" type="button" v-if="copyToClipboard" v-tooltip.click="__('Copy')"
          ...
          <button type="button" v-tooltip.click="__('Show')" class="text-70 hover:text-primary"
