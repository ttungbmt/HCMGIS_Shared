<template>
  <div v-if="isNotObject" class="flex items-center key-value-item">
    ...
    >
      <button
          type="button"
          class="flex appearance-none cursor-pointer text-70 hover:text-primary active:outline-none active:shadow-outline focus:outline-none focus:shadow-outline handle"
          title="Drag"
      >
        <icon type="menu" width="24" height="24" view-box="0 0 24 24" />
      </button>
    </div>
