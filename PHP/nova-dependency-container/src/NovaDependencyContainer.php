...
class NovaDependencyContainer extends Field
{
    ...
    public function dependsOnInclude($field, $values)
    {
        foreach ($values as $value) $this->dependsOn($field, $value);
        return $this;
    }
    ...
    public function resolveForDisplay($resource, $attribute = null)
    {
        ...
        foreach ($this->meta['dependencies'] as $index => $dependency) {
            ...
            $value = $this->resolveAttribute($resource, $dependency['property']);
